  ...
  if ($("#welcome").length) {
    ...
    request.onload = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        let fullname = ("Hej!") + " " + object.firstname + " " + object.lastname;
